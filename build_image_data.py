...
def main(unused_argv):
    ...
    filenames, texts, labels, train_split = _find_image_files(
        FLAGS.data_directory, FLAGS.labels_file, FLAGS.validation_ratio
    )

    # Run it!
    _process_image_files('train', filenames, texts, labels, train_split, FLAGS.train_shards)
    _process_image_files('validation', filenames, texts, labels, np.logical_not(train_split), FLAGS.validation_shards)
